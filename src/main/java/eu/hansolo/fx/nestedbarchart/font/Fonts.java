...
package eu.hansolo.fx.nestedbarchart.font;
...
public class Fonts {
    ...
    static {
        try {
            latoLightName              = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/nestedbarchart/font/Lato-Lig.otf"), 10).getName();
            latoRegularName            = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/nestedbarchart/font/Lato-Reg.otf"), 10).getName();
            latoBoldName               = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/nestedbarchart/font/Lato-Bol.otf"), 10).getName();
